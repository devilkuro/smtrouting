...
public:
    ...
    enum SMTLaneChangeMode {
        ...
        LANEMODE_EXT_TRACI_BY_SPEED = 0x02 << 8,
        LANEMODE_EXT_TRACI_NATURAL = 0x03 << 8,
        ...
        LANEMODE_AC_NSG_NDOR_ETBS = LANEMODE_ALLOW_STRATEGIC
                | LANEMODE_ALLOW_COOPERATIVE | LANEMODE_NO_SPEED_GAIN
                | LANEMODE_NO_DRIVE_ON_RIGHT | LANEMODE_EXT_TRACI_BY_SPEED,
        LANEMODE_FC_NSG_NDOR_ETBS = LANEMODE_ALLOW_STRATEGIC
                | LANEMODE_FORCE_COOPERATIVE | LANEMODE_NO_SPEED_GAIN
                | LANEMODE_NO_DRIVE_ON_RIGHT | LANEMODE_EXT_TRACI_BY_SPEED,
        LANEMODE_FC_ASG_NDOR_ETBS = LANEMODE_ALLOW_STRATEGIC
                | LANEMODE_FORCE_COOPERATIVE | LANEMODE_ALLOW_SPEED_GAIN
                | LANEMODE_NO_DRIVE_ON_RIGHT | LANEMODE_EXT_TRACI_BY_SPEED
    };
    // 获取Lane连接的下一跳lane列表

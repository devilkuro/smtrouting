...
public:
    ...
    enum SMTLaneChangeMode {
            ...
            LANEMODE_EXT_TRACI_ONLY_BY_SPEED = 0x10 << 8,
            LANEMODE_EXT_TRACI_NATURAL = 0x11 << 8,
            LANEMODE_ALLOW_ALL = LANEMODE_ALLOW_STRATEGIC | LANEMODE_ALLOW_COOPERATIVE | LANEMODE_ALLOW_SPEED_GAIN | LANEMODE_ALLOW_DRIVE_ON_RIGHT,
            LANEMODE_DISALLOW_ALL = LANEMODE_NO_STRATEGIC | LANEMODE_NO_COOPERATIVE | LANEMODE_NO_SPEED_GAIN | LANEMODE_NO_DRIVE_ON_RIGHT,
            LANEMODE_DISALLOW_OVERTAKE = LANEMODE_FORCE_STRATEGIC | LANEMODE_FORCE_COOPERATIVE | LANEMODE_NO_SPEED_GAIN | LANEMODE_NO_DRIVE_ON_RIGHT
                    | LANEMODE_EXT_TRACI_AVOID_COLLISIONS
        };
